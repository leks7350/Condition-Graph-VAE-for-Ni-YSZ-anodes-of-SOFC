# -*- coding: utf-8 -*-
"""0_FIBs_download.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1D5fEst5AzNA7p3-kPAc7Gyxa_PDKugD1
"""
...
def stack_to_2D(stacks, cube_size, overlap_fraction, output_dir):
  ...
  return filelist.append(filename)
...
def get_data(output='2D', output_dir='./data/', cube_size=456, overlap_fraction=0.5, balance=False, to_archive=False):
  ...
  if os.path.exists(input_seg_directory) ==False:
...
npylist = get_data(output='3D', to_archive=True)