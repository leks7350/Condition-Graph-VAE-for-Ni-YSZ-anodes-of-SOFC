...
Однотипные классы сгруппированы очень плотно, между разными образцами присутсвует явное расстояние. Визуальноая интерпретация латентного пространства весьма хорошее.
